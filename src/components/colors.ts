...
export const grayPalette = [
    grayColors.whiteSmoke,
    grayColors.gainsboro,
    grayColors.lightGray,
    grayColors.silver,
    grayColors.darkGray,
    grayColors.gray,
    grayColors.dimGray,
    grayColors.slateGray,
...
export const purplePalette = [
    ...
    purpleColors.mediumPurple,
    purpleColors.purple,
    purpleColors.indigo,
    purpleColors.darkSlateBlue
];
